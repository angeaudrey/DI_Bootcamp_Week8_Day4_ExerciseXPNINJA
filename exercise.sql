...
psql -U postgres -d exercisexpninja

--Insert three accounts with silver, gold, and platinum levels.

INSERT INTO accounts(first_name, last_name) VALUES('raissa', 'Kouabenan');
INSERT INTO accounts(first_name, last_name) VALUES('ange', 'kouabenan');
INSERT INTO accounts(first_name, last_name) VALUES('audrey', 'kouabenan');
...
INSERT INTO accounts(first_name, last_name) VALUES('Chani', 'Danielle');
